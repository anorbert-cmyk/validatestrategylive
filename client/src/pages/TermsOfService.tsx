        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              6-phase adversarial stress-test: (1) Discovery & Problem Anatomy, (2) Strategic Design & Roadmap,
              (3) AI Toolkit & Prompts, (4) Risk Assessment & ROI, (5) Competitor War Room, and (6) Go-to-Market Plan. The output is a tactical markdown report
