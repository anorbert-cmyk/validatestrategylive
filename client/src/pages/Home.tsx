...
const ADMIN_WALLET = (import.meta.env.VITE_ADMIN_WALLET_ADDRESS || "0xa14504ffe5E9A245c9d4079547Fa16fA0A823114").toLowerCase();
...
export default function Home() {
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      toast.info("Please sign the message to verify ownership", { duration: 4000 });
      const { nonce, message } = await getSiweNonce.mutateAsync({ walletAddress: address });
      ...
      toast.success("Successfully logged in", {
        description: `Connected as ${shortenAddress(address)}`
      });
